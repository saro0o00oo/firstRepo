...
class MlHelper:
    ...
    def train_with_splitted_data(self):
        print("Training {} Model with splitted training data...".format(
            self.model_name()))
    ...
    def train_with_whole_data(self):
        ...
        print("Training {} Model with ALL of training data...".format(
            self.model_name()))
    ...
    def train_and_evaluate_with_cross_validation(self, cv=5):
        ...
        CVS = cross_val_score(self.model, self.X, self.y,
                              scoring='accuracy', cv=cv)
        print(CVS)
        print("\n Mean accuracy of cross-validation: {}\n".format(CVS.mean()))

    def train_and_evaluate_with_splitted_data(self):
        self.train_with_splitted_data()
        self.evaluate_accuracy()

    def train_and_predict_with_whole_data(self):
        self.train_with_whole_data()
        return self.predict_with_whole_data()
